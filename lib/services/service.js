...
ServiceManager.prototype.startServices = function (config, callback) {
    ...
    async.eachSeries(['log', 'queue', 'job', 'ipfs', 'artifact', 'github', 'schedule'], function (serviceName, serviceCB) {
...
ServiceManager.prototype.stopServices = function (callback) {
    ...
    async.eachSeries(['test', 'queue', 'log', 'github', 'schedule'], function (serviceName, serviceCB) {
