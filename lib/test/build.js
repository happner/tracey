...
function updatePackage(tmpPath){
	...
	console.log('have tracey pack::::', tmpPath + path.sep + 'package.json');
	console.log('have tracey pack::::', tmpPath + path.sep + 'package.json');
	console.log('have tracey pack:::::');
	console.log('have tracey pack:::::');
...
function build (context) {
	...
	console.log('want to update package:::');
	console.log('want to update package:::');
	console.log('want to update package:::');
	console.log('want to update package:::');
	console.log('want to update package:::');

	updatePackage(context.path);
